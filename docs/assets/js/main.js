        ...
        const mainContents = [
            {
                body:`
<div class="bio">
<p>I am a seasoned Principal Software, Systems Engineer & Backend Developer with more than 25 years in software development and team management in Banking, Startup, Fintech and also collaborating across the globe in large companies as Microsoft.${vids}</p>
<p>As a side initiative, when time permits, I am actively working on my personal AI-First Research project, <a class="aiquanttradingresearch-lnk" href="https://github.com/samuel-santos-engineer/AIQuantTradingResearch"><i class="fa fa-github"></i> AIQuantTradingResearch</a>. Built under strict governance guardrails to reduce hallucinations and enforcing a zero-cost constraint, this project challenges me to deploy a resilient pipeline combining C#, .NET, Python, and SQLite across Docker containers in Azure cloud regions.</p>
